...
export class CrucigramaSaludableScene extends Phaser.Scene {
    ...
    private drawGrid(centerX: number, centerY: number) {
        ...
        for (const key in this.cells) {
            ...
            cell.rect = rect;
            cell.text = text;
            this.uiContainer.add([rect, text]);
    ...
    private drawHintsPanel(centerX: number, centerY: number) {
        ...
        this.uiContainer.add([bg, container]);
    ...
    private drawActionButtons(startX: number, startY: number) {
        ...
        createBtn(0, 0, 'C Limpiar', 0xEAE0D5, this.colorMaderaOscuro, () => this.limpiar());
        createBtn(200, 0, '💡 Pista', 0xF4A261, '#FFFFFF', () => this.darPista());
        createBtn(400, 0, '✓ Validar', this.colorVerde, '#FFFFFF', () => this.validar());
    }
