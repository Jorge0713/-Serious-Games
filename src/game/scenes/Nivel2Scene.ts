...
export class Nivel2Scene extends Phaser.Scene {
    ...
    private alimentos = [
        ...
        { id: "c2", ruta: "/iconsFood/cereales/tortilla.png", nombre: "Tortilla" },
    ...
    create() {
        ...
        this.add.text(width / 2, 130, 'Sigue acomodando los cereales y leguminosas', {
            fontSize: '32px',
            color: '#000',
    ...
    private mostrarPlaton(esFeliz: boolean) {
        ...
        this.tweens.add({
            targets: this.platon,
            alpha: 1,
            y: this.scale.height - 310, // Efecto "asomarse"
            duration: 300,
            ease: 'Back.easeOut',
            onComplete: () => {
